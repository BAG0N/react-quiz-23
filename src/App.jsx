  ...
  return (
    <main className='mx-auto max-w-4xl p-4 relative min-h-screen'>
      ...
      <motion.button
        ...
        className='absolute bottom-5 right-0 text-4xl rounded-full bg-primary aspect-square w-10 text-light grid place-items-center p-3 transition hover:brightness-90 group'
